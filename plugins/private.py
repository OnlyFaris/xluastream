...
async def start(client, message):
    buttons = [
            ...
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/OnlyFaris/173"),
                InlineKeyboardButton("SOURCE CODE", url="https://github.com/OnlyFaris/xluastream/tree/alpha"),
            ],
            [
